...
- **Waktu:** 2026-08-25 20:15:31
- **Mode:** `full`  ·  **Durasi total:** 395s  ·  **Pekerja statik:** 1
...
| config_wiring (INV-CFG-01/04, satu sumber kebenaran) | PASS (2s) |
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (13s) |
...
| verify_data_integrity (229 invarian domain/GL/alert/ledger/config/relasi/pembayaran/selisih/bank/kasus/kontrabon/antar-entitas) | PASS (4s) |
...
| audit_entity_isolation (E0.9/E0.10 — 0 kebocoran lintas-entitas) | PASS (13s) |
| POC FASE E-0 (bukti-merah L1–L21: notifikasi·denda·audit·lot·AR·transfer·dokumen·pratinjau) | PASS (4s) |
| POC FASE E-3 (mode “Semua Entitas” hanya-lihat: 409 menuntun · master bersama tetap boleh) | PASS (3s) |
| POC FASE E-4 (gudang bersama/khusus · harga per badan usaha · CSV) | PASS (4s) |
...
| POC P-0 (asal dokumen PO: PO→PR→SO · Nama Sales dirunut · PO rutin kosong-jujur · nol residu) | PASS (5s) |
...
| POC FASE G-3 (selisih pembayaran lebih/kurang bayar) | PASS (15s) |
